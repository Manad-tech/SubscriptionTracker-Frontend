    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-muted-foreground mb-8">
          Monitor spending, manage subscriptions, and never miss a renewal
          again.
        </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-8">
        ...
        >
          <h3 className="font-semibold mb-2">Subscription Tracker</h3>
        ...
        <div
          ...
          className="bg-card border border-border p-6 rounded-xl hover:-translate-y-2 hover:shadow-xl"
        >
          <h3 className="font-semibold mb-2">Spending Analytics</h3>
          <p className="text-muted-foreground">
